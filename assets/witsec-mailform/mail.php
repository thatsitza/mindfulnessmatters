...
$to = "michelle@mindfulnessmatters.co.za";														// To Address
$toAlt = "Michelle:michelle777@gmail.com";												// Additional Recipients
$from = "michelle@mindfulnessmatters.co.za";													// From Address
$fromName = "Mindfulness Matters Web Master";											// From Name
